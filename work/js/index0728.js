...
// ++선행(num01)
result = ++num01;
d.getElementById("result6").innerHTML = `<b>결과는 ${result}</b>, 변수는 <i>${num01}</i>`
// --선행 (num02)
result = --num02;
d.getElementById("result7").innerHTML = `<b>결과는 ${result}</b>, 변수는 <i>${num02}</i>`
// 후행++(num03)
result = num03++;
d.getElementById("result8").innerHTML = `<b>결과는 ${result}</b>, 변수는 <i>${num03}</i>`
// 후행--(num04)
result = num04--;
d.getElementById("result9").innerHTML = `<b>결과는 ${result}</b>, 변수는 <i>${num04}</i>`