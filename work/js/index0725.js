...
// 출력부
console.log(`${result}`);
d.getElementById("result").innerHTML=`<h1>[ 더하기+ ] ${result}</h>`;
...
console.log(`${result}`);
r.innerHTML = r.innerHTML + `<h1>[ 뺴기- ] ${result}</h>`;
...
result = num1 * num2;
console.log(`${result}`);
document.getElementById("result").innerHTML = document.getElementById("result").innerHTML + `<h1>[곱셈* ] ${result}</h>`;
